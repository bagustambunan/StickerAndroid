...
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.ANIMATED_STICKER_PACK;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.AVOID_CACHE;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.PACK_EMOJIS;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.IMAGE_DATA_VERSION;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.IOS_APP_DOWNLOAD_LINK_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.LICENSE_AGREENMENT_WEBSITE;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.PRIVACY_POLICY_WEBSITE;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.PUBLISHER_EMAIL;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.PUBLISHER_WEBSITE;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
import static com.DuduuStudio.StickerAndroid.StickerContentProvider.CHARACTER_IN_QUERY;
...
class StickerPackLoader {
    ...
    private static ArrayList<StickerPack> fetchFromContentProvider(Cursor cursor) {
        ...
        do {
            ...
            final String packEmojis = cursor.getString(cursor.getColumnIndexOrThrow((PACK_EMOJIS)));
            ...
            final String character = cursor.getString(cursor.getColumnIndexOrThrow(CHARACTER_IN_QUERY));
            final StickerPack stickerPack = new StickerPack(identifier, name, publisher, trayImage, publisherEmail, publisherWebsite, privacyPolicyWebsite, licenseAgreementWebsite, imageDataVersion, packEmojis, avoidCache, animatedStickerPack, character);
