...
public abstract class AddStickerPackActivity extends BaseActivity {
    ...
    private void actuallyAddSticker(String identifier, String stickerPackName) {
        try {
    ...
    protected void addStickerPackToWhatsApp(
            String identifier,
            String stickerPackName,
            boolean isPackWhitelisted
    ) {
        actuallyAddSticker(identifier, stickerPackName);
    }
