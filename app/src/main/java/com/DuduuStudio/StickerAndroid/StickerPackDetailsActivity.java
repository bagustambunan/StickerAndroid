...
//    private View feedbackFormButton;
    ...
    public boolean isPackWhitelisted = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView packEmojisTextView = findViewById(R.id.sticker_pack_emojis_text);
        SimpleDraweeView expandedStickerView = findViewById(R.id.sticker_details_expanded_sticker);
        density = getResources().getDisplayMetrics().density;
        fullWidth = getResources().getDisplayMetrics().widthPixels;

        addButton = findViewById(R.id.add_to_whatsapp_button);
//        feedbackFormButton = findViewById(R.id.feedback_form_button);
        getMoreButton = findViewById(R.id.get_more_button);
        ...
        addButton.setOnClickListener(v -> addStickerPackToWhatsApp(
        ...
        packEmojisTextView.setVisibility(!Objects.equals(stickerPack.packEmojis, "") ? View.VISIBLE : View.GONE);
        packEmojisTextView.setText(stickerPack.packEmojis);
//        feedbackFormButton.setOnClickListener(v -> launchWebpage(getResources().getString(R.string.app_feedback_form_website)));
        getMoreButton.setOnClickListener(v -> launchWebpage(getResources().getString(R.string.app_get_more_website)));
    }
    ...
    private void setIsPackWhitelisted(Boolean isWhitelisted) {
        isPackWhitelisted = isWhitelisted;
    }
    ...
    static class WhiteListCheckAsyncTask extends AsyncTask<StickerPack, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean isWhitelisted) {
            final StickerPackDetailsActivity stickerPackDetailsActivity = stickerPackDetailsActivityWeakReference.get();
            if (stickerPackDetailsActivity != null) {
                stickerPackDetailsActivity.setIsPackWhitelisted(isWhitelisted);
                stickerPackDetailsActivity.updateAddUI();
            }
        }
    }
}
