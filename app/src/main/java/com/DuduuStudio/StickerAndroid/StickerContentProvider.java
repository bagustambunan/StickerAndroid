...
public class StickerContentProvider extends ContentProvider {
    ...
    public static final String PACK_EMOJIS = "pack_emojis";
    public static final String AVOID_CACHE = "whatsapp_will_not_cache_stickers";
    public static final String ANIMATED_STICKER_PACK = "animated_sticker_pack";
    public static final String CHARACTER_IN_QUERY = "character";
    ...
    private synchronized void readCharacterFile(@NonNull Context context) {
        try (InputStream contentsInputStream = context.getAssets().open(CONTENT_FILE_NAME)) {
            characterList = ContentFileParser.parseCharacters(contentsInputStream);
        } catch (IOException | IllegalStateException e) {
            throw new RuntimeException(CONTENT_FILE_NAME + " file has some issues: " + e.getMessage(), e);
        }
    }
    ...
    public List<Character> getCharacterList() {
        if (characterList == null) {
            readCharacterFile(Objects.requireNonNull(getContext()));
        }
        return characterList;
    }

    // Static method to get character list
    public static List<Character> getCharacters(Context context) {
        ...
        return provider.getCharacterList();
    }
